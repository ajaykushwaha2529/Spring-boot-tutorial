package com.learning.springboot.studentservices;
...
import com.learning.springboot.studentservices.model.Student;
...
public class StudentService {
    ...
    public Course removeCourse(String studentId, String courseId){
        Student student = retrieveStudent(studentId);
        if (student == null) {
            return null;
        }

        Course removedCourse = student.courses().stream()
                .filter(course -> course.id().equals(courseId))
                .findAny()
                .orElse(null);
        int removedCourseIndex = student.courses().indexOf(removedCourse);
        student.courses().remove(removedCourseIndex);
